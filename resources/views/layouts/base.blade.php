...
<head>
	...
	<title>Home</title>
	<link rel="shortcut icon" type="image/x-icon" href="assets/images/20221215_183711_0000.png">
					...
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>
								...
								@elseif (Auth::user()->utype === 'PGW')
								<li class="menu-item menu-item-has-children parent">
									<a title="My Account" href="#">My Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency">
										<li class="menu-item">
											<a title="Dashboard" href="{{ route('user.dashboard') }}">Dashboard Pegawai</a>
										</li>
										<li class="menu-item">
											<a title="All Orders" href="{{route('admin.orders')}}">All Orders</a>
										</li>
										<li class="menu-item">
											<a title="My Profile" href="{{ route('user.profile') }}">Profile Pegawai</a>
										</li>
										<li class="menu-item">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/20221215_183711_0000.png')}}" alt="mercado"></a>
						</div>
